...
export default function useAgora(client) {
    var _this = this;
    var _a = useState(undefined), localVideoTrack = _a[0], setLocalVideoTrack = _a[1];
    var _b = useState(undefined), localAudioTrack = _b[0], setLocalAudioTrack = _b[1];
    var _c = useState([]), errors = _c[0], setErrors = _c[1];
    var _d = useState(false), joinState = _d[0], setJoinState = _d[1];
    // console.log(client?.connectionState);
    var _e = useState([]), remoteUsers = _e[0], setRemoteUsers = _e[1];
    function createLocalTracks(audioConfig, videoConfig) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, microphoneTrack, cameraTrack;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, AgoraRTC.createMicrophoneAndCameraTracks(audioConfig, videoConfig)];
                    case 1:
